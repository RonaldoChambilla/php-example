...
function agregarFilas(id,paciente) {
    ...
    "<td><button type='button' onclick=editar('"+paciente.id+"','"+paciente.nombres+"','"+paciente.edad+"','"+paciente.talla_m+"','"+paciente.peso_kg+"','"+paciente.sintoma_tos+"','"+paciente.sintoma_fiebre+"','"+paciente.sintoma_disnea+
...
function editar(id,nombres,edad,talla_m,peso_kg,sintoma_tos,sintoma_fiebre,sintoma_disnea,sintoma_dolormuscular,sintoma_gripe,sintoma_presionalta,sintoma_fatiga,sintoma_garraspera) {
...
function guardarOactualizar(accion) {
    const $id = $("#id2").val();
